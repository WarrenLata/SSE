...
try:
    ...
    def add_ConnectorServicer_to_server(servicer, server):
        ...
        generic_handler = grpc.method_handlers_generic_handler(
            ## TW: Creates a grpc.GenericHandler from RpcMethodHandlers
            'qlik.sse.Connector',
            rpc_method_handlers)  ## TW: 'qlik.sse.Connector' is the name of the service used for the method handlers
